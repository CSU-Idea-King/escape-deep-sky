...
public class Play extends JFrame{
    private int x=350,y=100,wide=1010,height=800;
    ...
    Thread thred1;//线程
    //构造方法
    public Play(String username, int score){ //p为玩家角色，1为火，2为冰
        ...
        myKey1 = new Mykey(this,1);
        myKey2 = new Mykey(this,2);
        ...
        playPanel.setBounds(0, 0,wide,height);
        this.setBounds(x, y,wide,height);
        setBack();               //添加控件
    ...
    public void setBack(){
        ...
        backgroundPicture.setBounds(0, 0,wide,height);
        ...
        this.addKeyListener(myKey1);
        this.addKeyListener(myKey2);
        try {
            people1.start();
            people2.start();//????
...
*/
    public static void main(String[] args) throws IOException {
        //Socket socket = new Socket("101.37.13.23", 11111);
        new Play("xingxing",0);
    }
}
